...
const goDetailPage = (compensationId) => {
  router.push(`/all/salary/compensation/detail/${compensationId}`);
}
</script>
  ...
  <div class="card">
    <div class="card-bd">
      <table class="table">
        ...
        <tr>
          <td>2025</td>
          <td @click="goDetailPage(1)">2025년 1월 인센티브 관리</td>
          <td>85,000,000</td>
          <td>결재완료 </td>
        </tr>
        <tr>
          <td>2024</td>
          <td @click="goDetailPage(1)">2024년 기본급 관리</td>
          <td>85,000,000</td>
          <td>결재완료 </td>
        </tr>
        </tbody>
